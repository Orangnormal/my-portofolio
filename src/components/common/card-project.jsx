...
const CardProject = ({ image, title, type, desc, link, programs, isReversed }) => {
    return (
        <div >
            ...
            <div  className='bg-[#323443] lg:w-[550px] h-[200px] md:h-[370px] bg-opacity-20 p-8 lg:p-10 rounded-xl relative'>
            ...
            <div   className='flex flex-col gap-9 lg:justify-between'>
                ...
                <p dangerouslySetInnerHTML={{ __html: desc }} className='font-normal text-[12px] md:text-[18px] lg:w-[650px] text-justify text-gray-200'></p>
                </div>
                ...
                {programs.map((program, index) => (
                    ...
                    <button
                        ...
                        style={{ color: program.color || 'inherit' }}
                    >
                        <program.logo />
                    </button>
